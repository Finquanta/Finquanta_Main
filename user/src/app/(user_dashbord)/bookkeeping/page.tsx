...
export default function BookkeepingPage() {
  ...
  return (
    <div className="h-full flex flex-col space-y-8 p-6 overflow-hidden">
      {/* Title */}
      <h1 className="text-2xl font-semibold text-gray-900 flex-shrink-0">Bookkeeping</h1>
      
      {/* Summary Cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16 flex-shrink-0">
