      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <Folder className="w-5 h-5 sm:w-8 sm:h-8 text-[#63d51d]" />
          </div>
        </div>
        <div className="bg-white p-3 sm:p-4 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <svg className="w-5 h-5 sm:w-8 sm:h-8 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.364 0l-2.8 2.034c-.755.588-1.84.7-2.4.183l-2.8-2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 011.364 0l2.8 2.034c.755.588 1.54-.148 1.118-2.034l1.07-3.292a1 1 0 00-.364-1.118L18.46 8.72c-.783-.57-1.24-.14-1.118 1.588l1.07 3.292z" />
            </svg>
          </div>
        </div>
        <div className="bg-white p-3 sm:p-4 rounded-lg border border-gray-200">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
          {folders.map((folder) => (
            <div
              ...
              className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white border border-gray-200 rounded-lg cursor-pointer hover:shadow-md hover:border-[#150578] transition-all"
            >
              <Folder className="w-5 h-5 sm:w-8 sm:h-8 text-[#150578] flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <h3 className="text-sm sm:text-base font-medium text-[#1b263b] truncate">{folder.name}</h3>
      ...
      <div>
        <div className="flex items-center justify-between mb-3 sm:mb-4 flex-wrap gap-2">
          ...
          <button
            ...
            className="text-xs sm:text-sm text-[#778da9] hover:text-[#150578] transition-colors"
          >
            ← Back to all folders
          </button>
        </div>
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md">
            ...
            <div
              className="border-2 border-dashed border-gray-300 rounded-lg p-6 sm:p-8 text-center hover:border-[#150578] transition-colors cursor-pointer"
