...
const onboardingStrings: Record<string, Record<string, string>> = {
  en: { skip: "Skip for now", progress: "Question {current} of {total}", back: "Back", continue: "Continue", finish: "Finish", saving: "Saving…", enterHint: "Press Enter ↵ to continue", required: "This one's required to continue.", saveError: "Could not save. Please try again.", qBusinessName: "What's your business name?", qBusinessType: "What type of business is it?", qIndustry: "What industry are you in?", qNiche: "What's your business niche?", qEntity: "What's your business structure?", qCountry: "What country are you based in?", qIncorporation: "Where is your business incorporated?", qMaturity: "What stage is your business at?", qRevenue: "What's your revenue range?", hintRevenue: "Roughly, across a full year.", qEmployees: "How many people work in the business?", qDebt: "Does the business have any loans or debt?", hintDebt: "Including credit cards, lines of credit and loans you've given out.", qPrimaryGoal: "What's your main financial goal right now?", hintPrimaryGoal: "We'll start a goal on your dashboard to match — you can change it anytime.", qGoals: "What are your financial goals?", qWebsite: "Do you have a website?", hintNiche: "Get specific — it helps us tailor things.", hintIncorporation: "State / region / country of incorporation.", hintGoals: "A sentence or two is plenty.", hintWebsite: "Optional — it appears on your invoices. You can add it later." },
